                                                                ...
                                                                <tr>
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="https://coyca.online/assets/img/registro_exitoso.png"
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align v-font-size"
                                                                ...
                                                                <p style="line-height: 140%;">Tienes un usuario nuevo registrado en la capacitación
                                                                {{$nombre_capacitacion}} con la siguiente información:</p><br>
                                                                ...
                                                                <p>Cargo: <strong>{{$cargo_usuario_registrado}}</strong></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
