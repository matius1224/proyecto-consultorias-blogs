                            ...
                            <div
                                ...
                                <div class="u-col u-col-100"
                                    ...
                                    <div style="background-color: #eaeff2;height: 100%;width: 100% !important;">
                                        <!--[if (!mso)&(!IE)]><!-->
                                        <div
                                            style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 10px solid #ffffff;border-left: 10px solid #ffffff;border-right: 10px solid #ffffff;border-bottom: 10px solid #ffffff;">
                                            <!--<![endif]-->
                                                                ...
                                                                <tr>
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="https://coyca.online/assets/img/imagen_correo_capacitacion.png"
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align v-font-size"
                                                                ...
                                                                <p style="line-height: 140%;">Tienes una nueva solicitud registrada en el área
                                                                {{$nombre_area}} con la siguiente información:</p><br>

                                                                <p>Nombre completo: <strong>{{$usuario_registrado}}</strong></p>
                                                                <p>Correo electrónico: <strong>{{$correo_usuario_registrado}}</strong></p>
                                                                <p>Whatsapp: <strong>{{$whatsapp_usuario_registrado}}</strong></p>
                                                                <p>Empresa: <strong>{{$empresa_usuario_registrado}}</strong></p>
                                                                <p>Descripción: <strong>{{$requerimiento_usuario_registrado}}</strong></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            ...
                                            <table id="u_content_text_1" style="font-family:'Raleway',sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:10px 40px;font-family:'Raleway',sans-serif;"
                                                            align="left">

                                                            <div class="v-text-align v-font-size"
                                                                style="font-size: 14px; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <p style="line-height: 140%;">Atentamente,
                                                                    Coyca Consultora</p>
                                                            </div>
                                                        </td>
                                                    </tr>
                        ...
                        <div class="u-row"
                            ...
                            <div
                                ...
                                <div class="u-col u-col-100"
                                    style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
                                    <div
                                        style="background-color: #eaeff2;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                        <!--[if (!mso)&(!IE)]><!-->
                                        <div
                                            style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 10px solid #ffffff;border-right: 10px solid #ffffff;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                            <!--<![endif]-->
                                                            ...
                                                            <tr>
                                                                <td class="v-text-align"
                                                                    ...
                                                                    <p>© <span>Copyright</span> <strong
                                                                            class="px-1 sitename"> Coyca</strong>
