...
<div class="contenedor">
    <div class="card carta-personalizada">
        ...
        <div class="card-body">
                    ...
                    <tbody class="cuerpo-tabla">
                        @forelse($blogsInactivos as $row)
                            <tr>
                                ...
                                @php
                                    $nombre_categoria = DB::table('categorias')->where('id',$row->id_categoria)->pluck('nombre')->first();
                                @endphp
            ...
            <div class="float-end">{{ $blogsInactivos->links() }}</div>
            <div class="float-start">Mostrando {{ $blogsInactivos->count() }} registros de un total de
                {{ $total }}
            </div>
        </div>
    </div>
