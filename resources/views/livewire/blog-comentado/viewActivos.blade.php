...
<div class="contenedor">
    <div class="card carta-personalizada">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive container-tabla tablas-generales">
                <table class="table table-sm">
                    ...
                    <tbody class="cuerpo-tabla">
                        @forelse($blogXcomentarios as $row)
                            <tr>
                                <td>{{ $row->titulo }}</td>
                                        ...
                                        <div class="dropdown blog">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left" aria-labelledby="blog">
                                                ...
                                                <a class="dropdown-item"
                                                    wire:click="modalInactivar({{ $row->comentario_id }})"><span
            ...
            <div class="float-end">{{ $blogXcomentarios->links() }}</div>
            <div class="float-start">Mostrando {{ $blogXcomentarios->count() }} registros de un total de {{ $totalBlogXcomentario }}
            </div>
        </div>
    </div>
</div>
