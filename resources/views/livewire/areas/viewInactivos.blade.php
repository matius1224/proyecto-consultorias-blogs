...
<div class="contenedor">
    <div class="card carta-personalizada">
        ...
        <div class="card-body">
            ...
            <div class="float-end">{{ $areasInactivas->links() }}</div>
            <div class="float-start">Mostrando {{ $areasInactivas->count() }} registros de un total de
                {{ $total }}
            </div>
        </div>
    </div>
