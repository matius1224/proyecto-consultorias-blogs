@section('title', __('Listado de usuarios por recurso'))
<div class="contenedor">
    <div class="card carta-personalizada">
        <div class="card-header">
            <h3 class="titulos-container text-center">Usuarios que descargaron recursos</h3>
        </div>
        <div class="card-body">
            ...
            <div class="table-responsive container-tabla tablas-generales">
                <table class="table table-sm">
                    ...
                    <tbody class="cuerpo-tabla">
                        @forelse($usuariosXRecursos as $row)
                            <tr>
            ...
            <div class="float-end">{{ $usuariosXRecursos->links() }}</div>
            <div class="float-start">Mostrando {{ $usuariosXRecursos->count() }} registros de un total de {{ $total }}
