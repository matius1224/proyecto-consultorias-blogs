        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createDataModalLabel">{{ $selected_id ? 'Editar categoria' : 'Crear categoria' }}
                    </h5>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <h3 class="text-center">
                        {{ $activar ? '¿Estas seguro de activar la categoria?' : '¿Estas seguro de inactivar la categoria?' }}
                    </h3>
                </div>
                <form wire:submit="{{ $activar ? 'activarCategoria' : 'inactivarCategoria' }}({{ $selected_id }})">
