...
<div>
    ...
    <body class="service-details-page">
        <main class="main">
            <!-- Page Title -->
            <div class="page-title" style="margin-top: 100px; margin-bottom: 50px">
                <div class="container d-lg-flex justify-content-between align-items-center">
                    <nav class="breadcrumbs">
                        <ol>
                            <li><a href="{{ route('blogDashboard') }}" wire:click="volverABlog">Blog</a></li>
            ...
            <section wire:ignore.self id="service-details" class="service-details section comentario"
