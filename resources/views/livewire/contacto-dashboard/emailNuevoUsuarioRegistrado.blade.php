                                                                ...
                                                                <tr>
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="https://coyca.online/assets/img/logo.png"
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align v-font-size"
                                                                ...
                                                                <p style="line-height: 140%;">Tienes una nueva solicitud de contacto
                                                                con la siguiente información:</p><br>

                                                                <p>Nombre completo: <strong>{{$usuario_contacto}}</strong></p>
                                                                <p>Correo electrónico: <strong>{{$email_contacto}}</strong></p>
                                                                <p>Whatsapp: <strong>{{$whatsapp_contacto}}</strong></p>
                                                                <p>Empresa: <strong>{{$empresa_contacto}}</strong></p>
                                                                <p>Tema de interés: <strong>{{$tema_de_interes}}</strong></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
