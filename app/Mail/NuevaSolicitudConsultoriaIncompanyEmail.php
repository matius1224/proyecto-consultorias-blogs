...
class NuevaSolicitudConsultoriaIncompanyEmail extends Mailable
{
    ...
    $empresa_usuario_registrado,$nombre_area)
    {
    ...
    {
        return new Envelope(
            subject: 'Nueva solicitud consultoria incompany',
        );
    }
    ...
    {
        return new Content(
            view: 'livewire.consultorias-dashboard.emailNuevaSolicitudIncompany',
        );
    }
